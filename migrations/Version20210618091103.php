 ...
 */
final class Version20210618091103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artistic_work (id INT AUTO_INCREMENT NOT NULL, gallery_echange_id INT DEFAULT NULL, category_id INT DEFAULT NULL, slug VARCHAR(191) NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, picture VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, description VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_CE5AAFC7989D9B62 (slug), INDEX IDX_CE5AAFC77C9DC91E (gallery_echange_id), INDEX IDX_CE5AAFC712469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE artistic_work ADD CONSTRAINT FK_CE5AAFC77C9DC91E FOREIGN KEY (gallery_echange_id) REFERENCES gallery_echange (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artistic_work DROP FOREIGN KEY FK_CE5AAFC77C9DC91E');
